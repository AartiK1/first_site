...
AmCharts.makeChart( "mapdiv_cusine", {
   ...
   */
    ...
    "areas": [
    { "id": "JP",
    "url": "../../templates/recipes-jap.html"},
      { "id": "IN",
    "url": "../../templates/recipes-indian.html"},
      { "id": "CN",
    "url": "../../templates/recipes-chinese"},
    { "id": "HK",
    "url": "../../templates/recipes-chinese"},
    { "id": "CO",
    "url": "../../templates/recipes-columbian"},
    { "id": "FR",
    "url": "../../templates/recipes-french"},
